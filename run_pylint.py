...
def main():
    ...
    threshold = get_threshold('./private/pylint_score.json', args.threshold, args.service, args.python_version)
    path = args.path
    rcfile = args.rcfile
    ...
    if score < threshold:
        ...
        store_threshold('./private/pylint_score.json', score, args.threshold, args.service, args.python_version)
        sys.exit(0)
